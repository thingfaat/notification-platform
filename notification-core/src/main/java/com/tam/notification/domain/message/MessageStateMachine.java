...
public final class MessageStateMachine {
    private static final Map<MessageStatus, Set<MessageStatus>> TRANSITIONS = Map.of(
            ...
            MessageStatus.QUEUED, Set.of(MessageStatus.THROTTLED, MessageStatus.SENDING, MessageStatus.CANCELLED),

            MessageStatus.THROTTLED, Set.of(MessageStatus.QUEUED, MessageStatus.CANCELLED),
